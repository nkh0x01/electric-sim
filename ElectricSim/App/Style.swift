...
extension ComponentKind {
    var sfSymbol: String {
        ...
        case .comb:       return "rectangle.bottomthird.inset.filled"
    ...
    var georgianShort: String {
        ...
        case .spd:        return "ზეძ. (SPD)"
        case .rcd:        return "დიფ. (RCD)"
        case .rcbo:       return "დიფ-ავტ. (RCBO)"
        case .mcb:        return "ავტომატი (MCB)"
        case .busbar:     return "შინა"
        case .comb:       return "სავარცხელი"
        case .blank:      return "ცარიელი"
        case .lamp:       return "ნათურა"
        case .socket:     return "როზეტი"
        case .motor:      return "ძრავა"
        case .mpcb:       return "ძრ.დამც. (MPCB)"
        ...
        case .smartSwitch: return "ჭკვ. ამომრთ."
        case .smartRelay: return "ჭკვ. რელე"
        case .smartDimmer: return "ჭკვ. დიმერი"
        case .smartMeter: return "ჭკვ. მრიცხ."
